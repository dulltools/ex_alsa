defmodule ExAlsa do
  @moduledoc """
  A NIF-backed module for interfacing with ALSA. The goal of this library is to act as a pass-through to ALSA, while attemping to improve the configuration experience.
  """
